...
class formacincoController extends Controller
{
    ...
    */
    public function datos($id)
    {
        ...
        ->where('in_005', '=', false)->exists()) {
            ...
            $data = tab_forma_005::select(
                ...
                'de_formula',
                'in_005',
                'de_observacion as de_observacion_005',
                'id_usuario_solicita',
                'id_usuario_procesa',
                'id_tab_estatus',
    ...
    public function guardar($id = null)
    {
        ...
        if($id!=''||$id!=null) {
            ...
            try {
                $validator= Validator::make(Input::all(), tab_proyecto::$validarEditar005);
                if ($validator->fails()) {
    ...
    */
    ...
    {
        return View::make('seguimiento.proyecto.005.cambio.lista');
    }
    ...
    public function storeListaCambio()
    {
        try {
            ...
            ->join('proyecto_seguimiento.tab_proyecto as t01', 'proyecto_seguimiento.tab_forma_005.id_tab_proyecto', '=', 't01.id')
            ...
            ->join('mantenimiento.tab_estatus as t04', 't04.id', '=', 'proyecto_seguimiento.tab_forma_005.id_tab_estatus')
            ->select(
                'proyecto_seguimiento.tab_forma_005.id',
                'tx_ejecutor',
                ...
                'nu_codigo',
                'de_nombre as de_proyecto',
                'proyecto_seguimiento.tab_forma_005.in_005',
                't01.id_ejecutor',
            ...
            if (Input::get("BuscarBy")=="true") {
                ...
                $response['data']  = $tab_forma_005->orderby('proyecto_seguimiento.tab_forma_005.id', 'ASC')->get()->toArray();
            } else {
                $response['success']  = 'true';
                $response['total'] = $tab_forma_005->count();
                $tab_forma_005->skip($start)->take($limit);
    ...
    */
    ...
    {
        $data = tab_forma_005::join('proyecto_seguimiento.tab_proyecto as t01', 'proyecto_seguimiento.tab_forma_005.id_tab_proyecto', '=', 't01.id')
        ->join('mantenimiento.tab_ejecutores as t02', 't01.id_tab_ejecutores', '=', 't02.id')
        ->join('mantenimiento.tab_lapso as t03', 't01.id_tab_lapso', '=', 't03.id')
        ->join('autenticacion.tab_usuarios as t04a', 'proyecto_seguimiento.tab_forma_005.id_usuario_solicita', '=', 't04a.id')
        ->leftJoin('autenticacion.tab_usuarios as t04b', 'proyecto_seguimiento.tab_forma_005.id_usuario_procesa', '=', 't04b.id')
        ->select(
            'proyecto_seguimiento.tab_forma_005.id',
            'tx_ejecutor',
            't01.id_tab_ejecutores',
            ...
            DB::raw("to_char(t03.fe_fin, 'dd/mm/YYYY') as fe_fin"),
            'nu_codigo',
            'proyecto_seguimiento.tab_forma_005.de_observacion',
            'de_nombre as de_proyecto',
            'proyecto_seguimiento.tab_forma_005.in_005',
            't01.id_ejecutor',
            DB::raw("to_char(proyecto_seguimiento.tab_forma_005.created_at, 'dd/mm/YYYY hh12:mi AM') as fe_solicitud")
        ...
        return View::make('seguimiento.proyecto.005.cambio.detalle')->with('data', $data);
    }
    ...
    */
    public function datosCambio($id)
    {
        ...
        return View::make('seguimiento.proyecto.005.cambio.editar')->with('data', $data);
    }
