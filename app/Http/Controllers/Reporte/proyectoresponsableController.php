...
class proyectoresponsableController extends Controller
{
    ...
    */
    ...
    <th align="center" bgcolor="#E6E6E6" style="width: 20%;"><b>TÉCNICO</b></th>
        ...
        ->select(
            'co_proyecto_responsables',
            'public.t37_proyecto_responsables.id_proyecto',
            'responsable_nombres',
            'reponsable_cedula',
            'responsable_correo',
    ...
    ';
      ...
      public function responsableExportar()
      {
          ...
          try {
              ...
              foreach ($responsable as $key => $value) {
                  ...
                  $objPHPExcel->getActiveSheet()->getStyle('A'.$rowCount.':G'.$final)->applyFromArray($styleThinBlackBorderOutline);
                  // Set cell An to the "name" column from the database (assuming you have a column called name)
                  //    where n is the Excel row number (ie cell A1 in the first row)
                  $objPHPExcel->getActiveSheet()->SetCellValue('A'.$rowCount, $value->id_ejecutor.' - '.$value->tx_ejecutor);
                  $objPHPExcel->getActiveSheet()->setCellValueExplicit('B'.$rowCount, $value->id_proyecto.' - '.$value->nombre, PHPExcel_Cell_DataType::TYPE_STRING);
                  /**Datos del Titular**/
                  $objPHPExcel->getActiveSheet()->SetCellValue('C'.$rowCount, $value->reponsable_cedula, PHPExcel_Cell_DataType::TYPE_STRING);
                  $objPHPExcel->getActiveSheet()->SetCellValue('D'.$rowCount, $value->responsable_nombres, PHPExcel_Cell_DataType::TYPE_STRING);
                  $objPHPExcel->getActiveSheet()->SetCellValue('E'.$rowCount, $value->responsable_unidad, PHPExcel_Cell_DataType::TYPE_STRING);
                  $objPHPExcel->getActiveSheet()->SetCellValue('F'.$rowCount, $value->responsable_correo, PHPExcel_Cell_DataType::TYPE_STRING);
                  $objPHPExcel->getActiveSheet()->SetCellValue('G'.$rowCount, $value->responsable_telefono);
                  $rowCount=$rowCount+1;
                  ...
                  $objPHPExcel->getActiveSheet()->SetCellValue('E'.$rowCount, $value->realizador_unidad, PHPExcel_Cell_DataType::TYPE_STRING);
                  $objPHPExcel->getActiveSheet()->SetCellValue('F'.$rowCount, $value->registrador_correo, PHPExcel_Cell_DataType::TYPE_STRING);
                  $objPHPExcel->getActiveSheet()->SetCellValue('G'.$rowCount, $value->registrador_telefono);
                  $rowCount=$rowCount+1;
                  /**Datos del Administrador**/
                  $objPHPExcel->getActiveSheet()->SetCellValue('C'.$rowCount, $value->administrador_cedula, PHPExcel_Cell_DataType::TYPE_STRING);
                  $objPHPExcel->getActiveSheet()->SetCellValue('D'.$rowCount, $value->administrador_nombres, PHPExcel_Cell_DataType::TYPE_STRING);
                  $objPHPExcel->getActiveSheet()->SetCellValue('E'.$rowCount, $value->administrador_unidad, PHPExcel_Cell_DataType::TYPE_STRING);
                  $objPHPExcel->getActiveSheet()->SetCellValue('F'.$rowCount, $value->administrador_correo, PHPExcel_Cell_DataType::TYPE_STRING);
                  $objPHPExcel->getActiveSheet()->SetCellValue('G'.$rowCount, $value->administrador_telefono);
                  $rowCount=$rowCount+1;
                  /**Datos del Tecnico**/
                  $objPHPExcel->getActiveSheet()->SetCellValue('C'.$rowCount, $value->tecnico_cedula, PHPExcel_Cell_DataType::TYPE_STRING);
                  $objPHPExcel->getActiveSheet()->SetCellValue('D'.$rowCount, $value->tecnico_nombres, PHPExcel_Cell_DataType::TYPE_STRING);
                  $objPHPExcel->getActiveSheet()->SetCellValue('E'.$rowCount, $value->tecnico_unidad, PHPExcel_Cell_DataType::TYPE_STRING);
                  $objPHPExcel->getActiveSheet()->SetCellValue('F'.$rowCount, $value->tecnico_correo, PHPExcel_Cell_DataType::TYPE_STRING);
                  $objPHPExcel->getActiveSheet()->SetCellValue('G'.$rowCount, $value->tecnico_telefono);
              ...
              header('Content-Disposition: attachment; filename="RESPONSABLES_PR_'.Input::get('id_ejecutor').'_'.Session::get('ejercicio').'_'.date("H:i:s").'.xlsx"');
      ...
      public function responsableTodoExportar()
      {
          ...
          try {
              ...
              $objPHPExcel->getActiveSheet()->getColumnDimension("F")->setWidth(30);
              $objPHPExcel->getActiveSheet()->getColumnDimension('G')->setWidth(15);
              $objPHPExcel->getActiveSheet()->setTitle(Session::get('ejercicio').'_RESPONSABLES');
              $objPHPExcel->getActiveSheet()->getStyle('A1:G1')->applyFromArray(
                  array(
                          'font'    => array(
                              'bold'      => true
              ...
              header('Content-type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
              // It will be called file.xls
              header('Content-Disposition: attachment; filename="RESPONSABLES_PR_'.Session::get('ejercicio').'_'.date("H:i:s").'.xlsx"');
              $objWriter->save('php://output');
