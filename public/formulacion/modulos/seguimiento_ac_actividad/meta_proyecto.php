...
$id_proyecto = decode($_POST['id_accion_centralizada']);
...
$sql = "SELECT mo_ae_calculado as total FROM ac_seguimiento.tab_ac_ae where id=".$codigo;
...
this.nuevo = new Ext.Button({
    ...
    handler:function(){
        ...
        this.msg.load({
         url:"formulacion/modulos/seguimiento_ac_actividad/editar_meta.php",
...
this.eliminar= new Ext.Button({
	...
	if(boton=="yes"){
        Ext.Ajax.request({
            ...
            params:{
                co_metas:metaLista.main.gridPanel_.getSelectionModel().getSelected().get('co_metas'), op: 12
            },
...
this.gridPanel_ = new Ext.grid.GridPanel({
    ...
    autoWidth: true,
    tbar:[
        this.nuevo,'-',this.buscador,'-',this.editar,'-',this.eliminar
    ],
    columns: [
    ...
    autoScroll:true,
    stateful: true,
    listeners:{cellclick:function(Grid, rowIndex, columnIndex,e ){metaLista.main.editar.enable();metaLista.main.eliminar.enable();}},
