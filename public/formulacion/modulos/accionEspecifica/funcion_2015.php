...
if($_GET['op']==1){
	$sql = "SELECT t39.*, de_unidad_medida, tx_ejecutor, mo_proy_ae_meta(co_proyecto_acc_espec) as mo_cargado FROM t39_proyecto_acc_espec as t39
	...
	inner join t44_partidas as t44 on t42.tx_pa||tx_ge=t44.co_partida
	WHERE co_proyecto_acc_espec='".$_POST['co_proyecto_acc_espec']."' AND t42.edo_reg is true AND t44.co_ejercicio_fiscal=t42.id_tab_ejercicio_fiscal";
	...
	$sql = "SELECT co_proyecto_acc_espec_rec, t40.id_proyecto, t40.co_proyecto_acc_espec, 'Presupuestaria (Bs)' AS tx_distribucion,
	...
	UNION
	SELECT co_proyecto_acc_espec_rec, t40.id_proyecto, t40.co_proyecto_acc_espec,'Fisico' AS tx_distribucion, 
	...
	if($_POST['paginar']=='si'){$sql.= " ORDER BY co_proyecto_acc_espec_rec, tx_distribucion, fecha_creacion ASC LIMIT ".$limit." OFFSET ".$start;}
	...
	$sql = "SELECT t39.*, de_unidad_medida, t24.tx_ejecutor, mo_proy_ae_meta(co_proyecto_acc_espec) as mo_cargado, t24b.tx_ejecutor as ejecutor_resp FROM t39_proyecto_acc_espec as t39
	inner join mantenimiento.tab_unidad_medida as t21 on t39.co_unidades_medida=t21.id
	inner join mantenimiento.tab_ejecutores as t24 on t39.co_ejecutores=t24.id
	...
	$sql = "SELECT t47.*, tx_unidades_medida, t24.tx_ejecutor, ('AC' || t24b.id_ejecutor || id_ejercicio || lpad(t46.id_accion::text, 5, '0')) as id_ac, t53.numero, t53.nombre, mo_ac_ae_meta(id_accion_centralizada, t47.id_accion) AS mo_cargado, t24b.tx_ejecutor as ejecutor_resp FROM t47_ac_accion_especifica as t47
	inner join t21_unidades_medida as t21 on t47.id_unidad_medida=t21.co_unidades_medida
	...
	if($_SESSION['co_rol']>2){
		$sql.=" WHERE t47.id_ejecutor = '".$_SESSION['id_ejecutor']."' AND t46.id_ejercicio = '".$_SESSION['ejercicio_fiscal']."' AND t47.edo_reg is true AND t46.edo_reg is true";	 
	}else{
