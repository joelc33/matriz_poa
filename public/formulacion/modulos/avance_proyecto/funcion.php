...
switch ($_POST['op']) {
	...
	$sql = "SELECT id_tab_meta_fisica, co_partida
  		FROM proyecto_seguimiento.tab_meta_financiera 
	...
	$sql = "SELECT * FROM proyecto_seguimiento.tab_meta_seguimiento
	WHERE id_tab_meta_fisica='".$_POST['id_tab_meta_fisica']."' and in_activo is true ";
	...
	if($codigo!=''||$codigo!=null){
		try{
			...
			$tabla="proyecto_seguimiento.tab_meta_seguimiento";
			$tquery="UPDATE";
			$id = 'id = '.$codigo;
			...
			if(array_key_exists("adjunto", $_FILES)){
				...
				foreach ($array as $key => $valor)
				{
					if($_FILES["adjunto"]["tmp_name"][$key]!='')
					{
						...
						$tabla1="proyecto_seguimiento.tab_meta_imagen";
						$tquery1="INSERT";
	...
	$sql = "SELECT id FROM proyecto_seguimiento.tab_meta_imagen
	...
	$sql = "DELETE FROM proyecto_seguimiento.tab_meta_imagen WHERE id =".$codigo.";";
