...
FROM t47_ac_accion_especifica as t47
	JOIN t24_ejecutores as t24 on t47.id_ejecutor = t24.id_ejecutor
	JOIN t53_ac_ae_predefinidas as t53 on t53.id = t47.id_accion
	JOIN t21_unidades_medida as t21 on t21.co_unidades_medida = id_unidad_medida
...
left join t44_partidas as t44 on t44.co_partida = t54.co_partida and t44.co_ejercicio_fiscal = t46.id_ejercicio
where t54.id_accion_centralizada = ? and t54.id_accion = ? and t46.edo_reg and t44.edo_reg
...
EOT;
		...
		case 21: //consulta de fuentes de financiamiento
			...
			$res = $comunes->EjecutarQuery(<<<EOT
select t56.id_tipo_fondo, t61.tx_tipo_fondo, t56.monto
