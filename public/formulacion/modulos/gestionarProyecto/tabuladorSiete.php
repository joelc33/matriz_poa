...
this.gridPanelAccion_ = new Ext.grid.GridPanel({
    ...
    {header: 'BIEN O SERVICIO', width:120,  menuDisabled:true, sortable: true,  dataIndex: 'bien_servicio'},
    ...
    autoScroll:true,
    stateful: true,
    listeners:{cellclick:function(Grid, rowIndex, columnIndex,e ){tabuladorSiete.main.editarAccion.enable();tabuladorSiete.main.verDetalle.enable();tabuladorSiete.main.eliminar.enable();}},
...
this.gridPanelFisica_ = new Ext.grid.GridPanel({
    ...
    autoScroll:true,
    stateful: true,
    listeners:{cellclick:function(Grid, rowIndex, columnIndex,e ){tabuladorSiete.main.verFisico.enable();tabuladorSiete.main.editarFisico.enable();}},
    bbar: new Ext.PagingToolbar({
        pageSize: 20,
        store: this.store_lista_fisica,
        displayInfo: true,
