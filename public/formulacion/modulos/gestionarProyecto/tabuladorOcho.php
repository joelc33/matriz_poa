...
this.verEspecifico = new Ext.Button({
	...
	handler: function(boton){
		addTab(tabuladorOcho.main.gridPanelEspecifica_.getSelectionModel().getSelected().get('co_proyecto_acc_espec'),'Proyecto '+tabuladorOcho.main.gridPanelEspecifica_.getSelectionModel().getSelected().get('id_proyecto')+', Accion Especifica '+tabuladorOcho.main.gridPanelEspecifica_.getSelectionModel().getSelected().get('tx_codigo'),'formulacion/modulos/accionEspecifica/listaPartidas.php','load','icon-reporteest','codigo='+tabuladorOcho.main.gridPanelEspecifica_.getSelectionModel().getSelected().get('co_proyecto_acc_espec'));
	}
});
...
getListaEspecifica: function(){
    ...
    url:'formulacion/modulos/accionDistribucion/funcion.php?op=1',
    root:'data',
    fields:[
