...
if($co_proyecto_responsables!=''||$co_proyecto_responsables!=null){
	$sql = "SELECT * FROM t37_proyecto_responsables WHERE co_proyecto_responsables=".$co_proyecto_responsables;
	$result = $comunes->ObtenerFilasBySqlSelect($sql);
	foreach($result as $key => $row){
		$data5 = json_encode(array(
			"co_proyecto_responsables"     => trim($row["co_proyecto_responsables"]),
