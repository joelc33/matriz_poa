        ...
        constructor: function(config) {
            ...
            this.store = Ext.create({
                ...
                proxy: new Ext.data.HttpProxy({
                    method: 'POST',
                    api: {
                        read: 'formulacion/modulos/seguimiento_ac/funcion.php?ae_dist='
                            + config.leer,
                        update: 'formulacion/modulos/seguimiento_ac_actividad/funcion.php?ae_dist='
                            + config.actualizar
                    }
                }),
                baseParams: {
    ...
    Ext.define('AccionCentralizada.AccionEspecifica_Partidas', {
        ...
        constructor: function(config) {
            ...
            config = Ext.apply({
                ...
                config.ac.nu_codigo + ' - ' + config.ae.numero,
                modal: true,
                maximizable: true,
                resizable: true,
                x: 0,
...
//                    this.cerrar
                ...
                columns: [{
                    ...
                    renderer: function(v, m, r) {
                        return v + ' ' + r.get('de_unidad_medida');
                    },
                    dataIndex: 'meta'
                }, {
