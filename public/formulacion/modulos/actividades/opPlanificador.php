...
/*var_dump($_SESSION['spe_session'][0]);
var_dump(array( 'de_privilegio' => 'proyecto.ver', 'in_habilitado' => true));
echo in_array( array( 'de_privilegio' => 'proyecto.ver', 'in_habilitado' => true), $_SESSION['spe_session'][0][0], true) ? 'true' : 'false';
exit();*/
...
this.gridPanel_ = new Ext.grid.GridPanel({
    ...
    autoWidth: true,
    tbar:[
<?php if( in_array( array( 'de_privilegio' => 'proyecto.ver', 'in_habilitado' => true), $_SESSION['spe_session'][0][0] )){ ?>
        this.ver,
<?php } ?>
<?php if( in_array( array( 'de_privilegio' => 'proyecto.ficha', 'in_habilitado' => true), $_SESSION['spe_session'][0][0] )){ ?>
	this.fichaProyecto,
<?php } ?>
<?php if( $usuario->co_rol < 3 ):?>
<?php if( in_array( array( 'de_privilegio' => 'proyecto.reabrir', 'in_habilitado' => true), $_SESSION['spe_session'][0][0] )){ ?>
...
var verCentralizadas = new Ext.Button({
	...
	handler: function( boton ) {
		...
		//Ext.Loader.load([
			//'formulacion/modulos/accionCentralizada/accion_centralizada.js'
		//], function () {
			...
			//var ac = Ext.create({
				...
				//ac: sel
			//});
			//self.tabpanel.add( ac );
			//self.tabpanel.setActiveTab( ac );
		//});
...
var reabrirCentralizadas = new Ext.Button({
	...
	iconCls: 'icon-buscar',
	handler: function( boton ) {
		var sel = opcionPlanificador.main.gridCentralizadas_
...
this.gridCentralizadas_ = new Ext.grid.GridPanel({
	...
	autoWidth: true,
	tbar:[
<?php if( in_array( array( 'de_privilegio' => 'ac.ver', 'in_habilitado' => true), $_SESSION['spe_session'][0][0] )){ ?>
		verCentralizadas,
<?php } ?>
<?php if( $usuario->co_rol < 3 ):?>
<?php if( in_array( array( 'de_privilegio' => 'ac.reabrir', 'in_habilitado' => true), $_SESSION['spe_session'][0][0] )){ ?>
...
<?php endif;?>
		...
		'->',
<?php if( in_array( array( 'de_privilegio' => 'ac.eliminar', 'in_habilitado' => true), $_SESSION['spe_session'][0][0] )){ ?>
