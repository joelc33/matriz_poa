...
if($codigo!=''||$codigo!=null){
	$sql = "SELECT * FROM proyecto_seguimiento.tab_meta_fisica
	where id=".$codigo;
...
this.nuevo = new Ext.Button({
	...
	handler: function(boton){
		paqueteComunJS.funcion.mostrarVentana({url:'formulacion/modulos/seguimiento_ae_actividad/meta_financiera.php?id_proyecto='+metaEditarPR.main.id_proyecto.getValue(),parametro:'no'});
	}
});
