...
this.fieldset1 = new Ext.form.FieldSet({
		...
		items:[
			this.fieldset1		
                ...
                buttonAlign:'left',
                buttons:[
<?php if( in_array( array( 'de_privilegio' => 'proyecto.poa.ejecutor', 'in_habilitado' => true), $_SESSION['spe_session'][0][0] )){ ?>
                {
...
<?php } ?>
<?php if( in_array( array( 'de_privilegio' => 'proyecto.poa.partida', 'in_habilitado' => true), $_SESSION['spe_session'][0][0] )){ ?>
		{text:'Resumen Partidas', iconCls:'icon-pdf',handler: this.onImprimir2},
<?php } ?>
<?php if( in_array( array( 'de_privilegio' => 'proyecto.poa.todos', 'in_habilitado' => true), $_SESSION['spe_session'][0][0] )){ ?>
		{text:'POA Todos', iconCls:'icon-pdf',handler: this.onImprimir1},
<?php } ?>
<?php if( in_array( array( 'de_privilegio' => 'proyecto.poa.exportar.partida', 'in_habilitado' => true), $_SESSION['spe_session'][0][0] )){ ?>
		{text:'Exportar Partidas', iconCls:'icon-excel',handler: this.onExportar1},
<?php } ?>
<?php if( in_array( array( 'de_privilegio' => 'proyecto.poa.exportar.todo', 'in_habilitado' => true), $_SESSION['spe_session'][0][0] )){ ?>
...
onLimpiar: function(){
    ...
    parametroPR.main.store_lista.baseParams={};
    parametroPR.main.store_lista.removeAll();
},
