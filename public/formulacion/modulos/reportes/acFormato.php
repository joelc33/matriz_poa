...
//=========================================== Datos del Reporte ====================================================/
	...
	function getRegistro($id_ejecutor){
		...
		$sql = "select t3.tx_codigo as nu_sector,t3.tx_descripcion as tx_sector,t46.id as id_accion_centralizada,
                ...
                t2.id_ejecutor,t3.tx_codigo||'.'||t1.nu_original||'.00.'||t4.nu_numero as co_presupuesto,t1.nu_original
	...
	where t46.edo_reg is true and ".$condicionAC." t46.id_ejercicio = ".$_SESSION['ejercicio_fiscal']." group by 1,2,3,4,5,6,7,8,t4.de_nombre,10,t1.nu_original  order by 1 asc, t1.nu_original asc, 4 asc";
...
<table border="0.1" style="width:100%;text-align: center;" cellpadding="3">
	...
	<tr align="left">
		<td colspan="2"><b>'.$campo['tx_sector'].': </b>'.$campo['inst_objetivos'].'</td>
	</tr>
	<tr align="left">
