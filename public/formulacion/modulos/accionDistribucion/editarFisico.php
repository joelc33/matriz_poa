...
if($codigo!=''||$codigo!=null){
	$sql = "SELECT t40.*,descripcion,tx_codigo FROM t40_proyecto_acc_espec_rec as t40
...
this.fielset2 = new Ext.form.FieldSet({
              title:'MESES: Distribucion Fisica',width:620,
              items:[
		this.fisico_01,
		this.fisico_02,
		this.fisico_03,
...
this.guardar = new Ext.Button({
    ...
    handler:function(){
        ...
        importarEditar.main.formPanel_.getForm().submit({
            method:'POST',
            url:'formulacion/modulos/accionDistribucion/funcion.php?op=3',
