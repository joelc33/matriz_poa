...
$sql = "SELECT id_proyecto, total, in_definitivo FROM t39_proyecto_acc_espec where co_proyecto_acc_espec=".$codigo;
$resultado = $comunes->ObtenerFilasBySqlSelect($sql);
$resultadoIdProyecto = $resultado[0]['id_proyecto'];
...
this.nuevo = new Ext.Button({
    ...
    handler:function(){
        ...
        this.msg.load({
         url:"formulacion/modulos/metas/editarMeta.php",
	 params: {co_proyecto_acc_espec:metaLista.main.co_proyecto_acc_espec.getValue(),id_proyecto:metaLista.main.id_proyecto.getValue()},
         scripts: true,
         text: "Cargando.."
        });
    }
...
this.editar= new Ext.Button({
	...
	metaLista.main.mascara.show();
        ...
        this.msg.load({
	 method:'POST',
	 params:{codigo:this.codigo,id_proyecto:metaLista.main.id_proyecto.getValue()},
         url:"formulacion/modulos/metas/editarMeta.php",
         scripts: true,
         text: "Cargando.."
        });
...
this.eliminar= new Ext.Button({
	...
	if(boton=="yes"){
        Ext.Ajax.request({
            method:'POST',
            url:'formulacion/modulos/metas/funcion.php?op=13',
            params:{
...
this.ver= new Ext.Button({
	...
	metaLista.main.mascara.show();
	 ...
	 method:'POST',
	 params:{codigo:this.codigo,id_proyecto:metaLista.main.id_proyecto.getValue()},
         url:"formulacion/modulos/metas/verMetaPr.php",
         scripts: true,
         text: "Cargando.."
        });
    }
...
<?php if($resultadoDefinitivo <> true){ ?>
    tbar:[
<?php if( in_array( array( 'de_privilegio' => 'proyecto.ae.actividad.nueva', 'in_habilitado' => true), $_SESSION['spe_session'][0][0] )){ ?>
        this.nuevo,'-',
<?php } ?>
	this.buscador,'-',
<?php if( in_array( array( 'de_privilegio' => 'proyecto.ae.actividad.editar', 'in_habilitado' => true), $_SESSION['spe_session'][0][0] )){ ?>
	this.editar,'-',
<?php } ?>
<?php if( in_array( array( 'de_privilegio' => 'proyecto.ae.actividad.borrar', 'in_habilitado' => true), $_SESSION['spe_session'][0][0] )){ ?>
	this.eliminar
<?php } ?>
    ],
<?php }else{ ?>
    tbar:[
        this.ver,'-',
	this.buscador,'->',
<?php if( in_array( array( 'de_privilegio' => 'proyecto.ae.actividad.reabrir', 'in_habilitado' => true), $_SESSION['spe_session'][0][0] )){ ?>
...
<?php } ?>
	...
	new Ext.ux.StatusBar({
	    ...
	    items:[
		this.resultadoReal,'-',
<?php if( in_array( array( 'de_privilegio' => 'proyecto.ae.actividad.cerrar', 'in_habilitado' => true), $_SESSION['spe_session'][0][0] )){ ?>
...
getLista: function(){
    ...
    url:'formulacion/modulos/metas/funcion.php?op=1',
    root:'data',
    fields:[
    {name: 'co_metas'},
    {name: 'tx_codigo'},
