...
this.fecha_inicio = new Ext.form.DateField({
	...
	value:this.OBJ.fecha_inicio?this.OBJ.fecha_inicio:'01-01-'+this.OBJ.id_ejercicio,
	allowBlank:false,
	width:100,
...
this.fecha_culminacion = new Ext.form.DateField({
	...
	value:this.OBJ.fecha_culminacion?this.OBJ.fecha_culminacion:'31-12-'+this.OBJ.id_ejercicio,
	allowBlank:false,
	width:100,
	minValue:'01-01-'+this.OBJ.id_ejercicio,
	maxValue:'31-12-'+this.OBJ.id_ejercicio
...
//**************************//
        metaEditar.main.formPanel_.getForm().submit({
            method:'POST',
            url:'formulacion/modulos/metas/funcion.php?op=9',
...
width:714,
	...
	bbar: [
		'->',
<?php if( in_array( array( 'de_privilegio' => 'ac.ae.actividad.metafisica.guardar', 'in_habilitado' => true), $_SESSION['spe_session'][0][0] )){ ?>
		this.guardar,
<?php } ?>
	],
    /*buttons:[
