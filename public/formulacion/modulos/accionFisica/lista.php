...
this.accionFisica2 = new Ext.Button({
	...
	handler: function(boton){
                        addTab(accionEspLista.main.gridPanel_2.getSelectionModel().getSelected().get('id_tab_t47_ac_accion_especifica'),'Programa:'+accionEspLista.main.gridPanel_2.getSelectionModel().getSelected().get('id_proyecto')+' >  Actividad:'+accionEspLista.main.gridPanel_2.getSelectionModel().getSelected().get('tx_codigo') +' >  Monto:'+accionEspLista.main.gridPanel_2.getSelectionModel().getSelected().get('total'),'formulacion/modulos/metas/acLista.php','load','icon-accion_especifica','codigo='+accionEspLista.main.gridPanel_2.getSelectionModel().getSelected().get('co_proyecto_acc_espec')+'&id_accion_centralizada='+accionEspLista.main.gridPanel_2.getSelectionModel().getSelected().get('id_accion_centralizada')+'&id_tab_t47_ac_accion_especifica='+accionEspLista.main.gridPanel_2.getSelectionModel().getSelected().get('id_tab_t47_ac_accion_especifica'));
	}
});
