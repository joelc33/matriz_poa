...
this.guardar = new Ext.Button({
	...
	if(metafinancieraEditar.main.formPanel_.form.isValid()){
		var e = new forma004ActividadEditar.main.Registro({
			co_municipio:metafinancieraEditar.main.id_tab_municipio_detalle.getValue(),
			tx_municipio:metafinancieraEditar.main.id_tab_municipio_detalle.getRawValue(),
			co_parroquia:metafinancieraEditar.main.id_tab_parroquia_detalle.getValue(),
	    		tx_parroquia:metafinancieraEditar.main.id_tab_parroquia_detalle.getRawValue(),
			mo_presupuesto:metafinancieraEditar.main.mo_presupuesto.getValue(),
			co_partida:metafinancieraEditar.main.co_partida.getValue(),
			co_fuente_financiamiento:metafinancieraEditar.main.id_tab_fuente_financiamiento.getValue(),
	    		tx_fuente_financiamiento:metafinancieraEditar.main.id_tab_fuente_financiamiento.getRawValue()
		});
		var cant = forma004ActividadEditar.main.store_lista.getCount();
			(cant==0)?0:forma004ActividadEditar.main.store_lista.getCount()+1;

			forma004ActividadEditar.main.store_lista.insert(cant, e);
			forma004ActividadEditar.main.gridPanel_.getView().refresh();
